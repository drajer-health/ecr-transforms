...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:lcg="http://www.lantanagroup.com" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir"
  xmlns:uuid="http://www.uuid.org" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" exclude-result-prefixes="lcg xsl cda fhir">
  ...
  <xsl:template match="fhir:PlanDefinition[fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/rr-relevant-reportable-condition-plandefinition']" mode="communication">
    ...
    <entryRelationship typeCode="COMP">
      <organizer classCode="CLUSTER" moodCode="EVN">
        ...
        <statusCode code="completed" />
        <!-- Responsible Agency -->
        <xsl:apply-templates select="fhir:jurisdiction/fhir:extension[@url = 'http://hl7.org/fhir/us/ecr/StructureDefinition/rr-responsible-agency-organization-extension']" mode="communication" />
        <!-- Rules Authoring Agency -->
        <xsl:apply-templates select="fhir:publisher/fhir:extension[@url = 'http://hl7.org/fhir/us/ecr/StructureDefinition/rr-rules-authoring-agency-organization-extension']" mode="communication" />
        <!-- Routing Entity -->
        <xsl:apply-templates select="fhir:jurisdiction/fhir:extension[@url = 'http://hl7.org/fhir/us/ecr/StructureDefinition/rr-routing-entity-organization-extension']" mode="communication" />
