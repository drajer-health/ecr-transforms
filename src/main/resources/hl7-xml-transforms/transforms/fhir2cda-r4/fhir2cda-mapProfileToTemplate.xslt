...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="urn:hl7-org:v3" xmlns:lcg="http://www.lantanagroup.com" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir"
  ...
  <xsl:template match="fhir:*" mode="map-resource-to-template">
    ...
    <xsl:choose>
      ...
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/rr-communication'">
      ...
      <xsl:when test="local-name() = 'topic' and preceding-sibling::*/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/rr-communication' and $pElementType = 'section'">
      ...
      <xsl:when test="@id = 'relevant-reportable-condition'">
      ...
      <xsl:when test="@id = 'eicr-information'">
      ...
      <xsl:when test="@id = 'reportability-response-summary'">
      ...
      <xsl:when test="local-name() = 'DocumentReference' and fhir:type/fhir:coding[fhir:system/@value = 'http://loinc.org']/fhir:code/@value = '55751-2'">
      ...
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/pregnancy-status-observation'">
      ...
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/eicr-condition'">
        <xsl:comment select="' [C-CDA R1.1] Problem Observation'" />
        <templateId root="2.16.840.1.113883.10.20.22.4.4" />
      ...
      <!-- us-core-observation-lab maps containing hasMember maps to organizer (not observation) -->
      ...
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/characteristics-of-home-environment'">
        <xsl:comment select="' [C-CDA R2] Characteristics of Home Environment '" />
        <templateId root="2.16.840.1.113883.10.20.22.4.109" />
      </xsl:when>
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/travel-history-observation'">
        <xsl:comment select="' [eICR R2 STU1.1] Travel History '" />
        <templateId root="2.16.840.1.113883.10.20.15.2.3.1" extension="2016-12-01" />
      </xsl:when>
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/pregnancy-outcome-observation'">
        <xsl:comment select="' [C-CDA PREG] Pregnancy Outcome '" />
        <templateId root="2.16.840.1.113883.10.20.22.4.284" extension="2018-04-01" />
      </xsl:when>
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/last-menstrual-period'">
      ...
      <xsl:when test="fhir:meta/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/postpartum-status'">
      ...
      <xsl:when test="local-name() = 'topic' and preceding-sibling::*/fhir:profile/@value = 'http://hl7.org/fhir/us/ecr/StructureDefinition/rr-communication'">
        <xsl:comment select="' [C-CDA R2.1] Instruction (V2) '" />
        <templateId root="2.16.840.1.113883.10.20.22.4.20" extension="2014-06-09" />
