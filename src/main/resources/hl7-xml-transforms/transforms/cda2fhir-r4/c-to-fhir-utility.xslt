...
<xsl:stylesheet xmlns="http://hl7.org/fhir" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:cda="urn:hl7-org:v3" xmlns:fhir="http://hl7.org/fhir" xmlns:sdtc="urn:hl7-org:sdtc"
  xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:lcg="http://www.lantanagroup.com"
   version="2.0" exclude-result-prefixes="lcg cda fhir xs xsi sdtc xhtml">
  ...
  <!-- Variable to get the name of the IG so we don't have to keep checking the document templateId -->
  ...
  <xsl:template match="*" mode="participant2profile">
    ...
    <xsl:for-each select="/cda:ClinicalDocument/cda:templateId">
      <!-- Only worrying about @root of the templateId -->
      <xsl:variable name="vTemplateId" select="@root" as="xs:string" />
      <!-- Get our string with templateId for the beginning of the XPath -->
      <xsl:variable name="vClinicalDocument" select="concat('ClinicalDocument[templateId/@root=''', $vTemplateId, ''']/')" />
  ...
  -->
  <xsl:template
    match="cda:code | cda:confidentialityCode | cda:maritalStatusCode | cda:routeCode | cda:raceCode | sdtc:raceCode | cda:ethnicGroupCode | cda:religiousAffiliationCode | cda:targetSiteCode | cda:priorityCode | cda:translation | cda:methodCode">
  ...
  <xsl:template name="author-reference">
    ...
    <!-- SG: Updated to handle no author (or if author is a device) (default to encompassingEncounter/responsibleParty/assignedEntity and
    ...
    <xsl:if
      test="cda:author/cda:assignedAuthor[cda:assignedPerson or cda:assignedDevice] or ancestor::cda:section[1]/cda:author[1]/cda:assignedAuthor or /cda:ClinicalDocument/cda:author[1]/cda:assignedAuthor[cda:assignedPerson] or /cda:ClinicalDocument/cda:componentOf/cda:encompassingEncounter/cda:responsibleParty">
      <xsl:element name="{$pElementName}">
        <xsl:choose>
          ...
          <xsl:when test="$pPractitionerRole = false() and /cda:ClinicalDocument/cda:author[1]/cda:assignedAuthor/cda:assignedPerson">
            <reference value="urn:uuid:{/cda:ClinicalDocument/cda:author[1]/cda:assignedAuthor/cda:assignedPerson/@lcg:uuid}" />
          </xsl:when>
        </xsl:choose>
      </xsl:element>
